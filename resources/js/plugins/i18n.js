...
const messages = {
  ...
  'en': {
    ...
    formulário: 'Application form for the ENEE statute',
    ...
    feminino: 'Female',
    outro: 'Other',
    residencia: 'Residence during class time',
    ...
    motora: 'Motor',
    psicológico: 'Diseases of the Psychological, neurological or psychiatric Forum',
    outras_doenças: 'Other diseases',
