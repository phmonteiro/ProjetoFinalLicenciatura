...
const messages = {
  'pt': {
    ...
    confirmar: 'Confirmar',
    contacto_emergencia: 'Identificação do Contacto de Emergência (Opcional)',
    ...
    identificação_responsável: 'Identificação do Responsável pelo ENE',
    ...
    info_documents: 'Pode anexar aqui os relatórios médicos entre outros ficheiros comprovativos',
    ...
    mensagem_renovar_estatuto: 'O seu estatuto expirou, por favor incie o processo de renovação de estatuto',
  },
  'en': {
    ...
    comentário: 'Comment',
    confirmar: 'Confirm',
    contacto_emergencia: 'Identification Emergency Contact (Optional)',
    ...
    identificação_responsável: 'Identification of ENE Carer',
