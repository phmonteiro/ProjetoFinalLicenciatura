                ...
                <b-col>
                    ...
                    <div class="form-group">
                        <b-form-select v-model="service.name" class="mb-3">
                            ...
                            <option value="Mais tempo na realização de avaliações">Mais tempo na realização de
                                avaliações</option>
                        </b-form-select>
                    </div>
                    <div class="form-group">
                        <label for="comment">Motivo:</label>
                        <textarea class="form-control" id="reason" v-model="service.reason" name="reason"
                            rows="3"></textarea>
                    </div>
                    <button type="submit" class="btn btn-primary" v-on:click.prevent="setService()">Pedir
                        serviço</button>
                </b-col>
            </b-row>
        </b-container>
