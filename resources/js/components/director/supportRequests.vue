  ...
  <div>
    ...
    <div class="container">
      <h2>Lista de pedidos a apoios</h2>
        ...
        <div v-if="supportRequests!=null && supportRequests.length!==0">
            <b-table striped hover :items="supportRequests" :fields="fields">
        ...
        <div v-else>
            <br>
            <h5>De momento não existe nenhum pedido de apoio.</h5>
        </div>
    </div>
  </div>
</template>
