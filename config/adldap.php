            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'domain_controllers' => ['dc2c2.ipleiria.pt', 'dc1c2.ipleiria.pt'],
                ...
                */
                ...
                | The base distinguished name is the base distinguished name you' d like
                    | to perform operation s on. An example base DN w o uld b e  D C=cor p, D C=a cme,DC=org.
                    |
                    |
            if one is not defined, then Adldap will try to find  it a utomatically
        | by querying your server. It's recommended to include it to
                | limit queries executed per reques t.
                    |
                    */
                ...
                'admin_username' =>  env('USERNAME ', 'salas'),
                'admin_password' => env('PASSWORD', '$@l@$'),
                ...
                |
                | This option is defaulted to fals e.
                 |
                */
                ...
                | if you have the ability to connect to your server securel y.
                 |
                 */
